...
albero creaAlberoBilanciato(char array[], int dim);
void inserisciNodoBilanciato(albero & radice, char array[], int indiceBasso, int indiceAlto);
int leggiArray(char array[], char * file);
void ordinaArray(char array[], int dim);
...
int main(int argc, char* argv[]) {
    ...
    /** Lettura del file */
    char array[100];
    int dim = leggiArray(array, argv[1]);
